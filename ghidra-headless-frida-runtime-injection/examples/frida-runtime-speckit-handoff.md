...
- confirm handoff goes to `ghidra-headless-frida-evidence`
```
...
- Runtime review record:
  [`../../../../specs/011-frida-skill-integration/evidence/us1-runtime-routing-review.md`](../../../../specs/011-frida-skill-integration/evidence/us1-runtime-routing-review.md)
- Evidence-import handoff example:
  [`../../ghidra-headless-frida-evidence/examples/frida-trace-handoff.md`](../../ghidra-headless-frida-evidence/examples/frida-trace-handoff.md)
