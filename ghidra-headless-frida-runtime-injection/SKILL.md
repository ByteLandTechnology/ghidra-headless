---
name: "ghidra-headless-frida-runtime-injection"
...
- Reusable script-library coverage gaps, behavior changes, or helper changes
  route to [`../ghidra-headless-script-review/SKILL.md`](../ghidra-headless-script-review/SKILL.md).
...
- Move to [`../ghidra-headless-frida-evidence/SKILL.md`](../ghidra-headless-frida-evidence/SKILL.md)
  once capture artifacts and the capture manifest are ready for import and
  adjudication.
- Move to [`../ghidra-headless-script-review/SKILL.md`](../ghidra-headless-script-review/SKILL.md)
