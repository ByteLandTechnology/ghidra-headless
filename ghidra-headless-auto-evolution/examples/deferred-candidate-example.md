...
- [`../../ghidra-headless/examples/ghidra-script-authoring.md`](../../ghidra-headless/examples/ghidra-script-authoring.md)
- [`../../ghidra-headless/examples/ghidra-script-review-checklist.md`](../../ghidra-headless/examples/ghidra-script-review-checklist.md)
...
| --------------------------------------------------------------------------- | -------------- | ------------------------------------------ | ----------------- | ----------------------------- |
| `.agents/skills/ghidra-headless/examples/ghidra-script-authoring.md`        | `workflow_doc` | `.agents/skills/ghidra-headless/examples/` | `leave_unchanged` | `internal_supporting_surface` |
| `.agents/skills/ghidra-headless/examples/ghidra-script-review-checklist.md` | `workflow_doc` | `.agents/skills/ghidra-headless/examples/` | `leave_unchanged` | `internal_supporting_surface` |
