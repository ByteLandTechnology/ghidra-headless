...
- Completed repository work that introduced the
  `ghidra-headless-auto-evolution` child skill and its review template.
- [`../SKILL.md`](../SKILL.md)
...
| -------------------------------- | ---------------------------------- | --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `decision-auto-evolution-create` | `auto-evolution-child-skill-entry` | `direct_create` | `.agents/skills/ghidra-headless-auto-evolution/SKILL.md`; `.agents/skills/ghidra-headless-auto-evolution/templates/auto-evolution-review-record.md`; `.agents/skills/ghidra-headless-auto-evolution/examples/direct-promotion-example.md`; `.agents/skills/ghidra-headless-auto-evolution/examples/deferred-candidate-example.md`; `.agents/skills/ghidra-headless/SKILL.md` | Existing phase skills cover intake, evidence, and script authoring, but none owns post-task auto evolution. A new child-skill entry is justified, while the umbrella skill is updated instead of duplicated elsewhere. | One real task produced a complete, reviewable evidence set and named tracked paths for the supported new workflow surface. | Any future runtime helper or export discovered during auto evolution still remains under `.work/ghidra-artifacts/`; this example promotes only tracked Markdown skill assets. |

## Asset Target Summary

| asset_path                                                                                | asset_type          | parent_surface                                             | change_mode       | review_visibility     |
| ----------------------------------------------------------------------------------------- | ------------------- | ---------------------------------------------------------- | ----------------- | --------------------- |
| `.agents/skills/ghidra-headless-auto-evolution/SKILL.md`                                  | `child_skill_entry` | `.agents/skills/ghidra-headless-auto-evolution/`           | `create_new`      | `child_skill_visible` |
| `.agents/skills/ghidra-headless-auto-evolution/templates/auto-evolution-review-record.md` | `template`          | `.agents/skills/ghidra-headless-auto-evolution/templates/` | `create_new`      | `child_skill_visible` |
| `.agents/skills/ghidra-headless-auto-evolution/examples/direct-promotion-example.md`      | `example`           | `.agents/skills/ghidra-headless-auto-evolution/examples/`  | `create_new`      | `child_skill_visible` |
| `.agents/skills/ghidra-headless-auto-evolution/examples/deferred-candidate-example.md`    | `example`           | `.agents/skills/ghidra-headless-auto-evolution/examples/`  | `create_new`      | `child_skill_visible` |
| `.agents/skills/ghidra-headless/SKILL.md`                                                 | `skill_file`        | `.agents/skills/ghidra-headless/`                          | `update_existing` | `umbrella_visible`    |
