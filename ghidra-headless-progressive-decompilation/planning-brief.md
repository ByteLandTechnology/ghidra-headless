...
- plan.md
- tasks.md
  example_path: .agents/skills/ghidra-headless-progressive-decompilation/examples/progressive-decomp-speckit-handoff.md
...
- Stage rules and Stage 6 entry criteria:
  [`../ghidra-headless/examples/analysis-selection-playbook.md`](../ghidra-headless/examples/analysis-selection-playbook.md)
- Current selection and compare-input surface:
  [`../ghidra-headless/examples/artifacts/sample-target/input-inventory.md`](../ghidra-headless/examples/artifacts/sample-target/input-inventory.md)
- Replayable Stage 6 command surface:
  [`../ghidra-headless/examples/artifacts/sample-target/command-manifest.md`](../ghidra-headless/examples/artifacts/sample-target/command-manifest.md)
- Reviewable compare record:
  [`../ghidra-headless/examples/artifacts/sample-target/comparison-command-log.md`](../ghidra-headless/examples/artifacts/sample-target/comparison-command-log.md)
