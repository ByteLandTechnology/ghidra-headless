...
'.agents/skills/ghidra-headless/' or
'.claude/skills/ghidra-headless/') are tracked sample
...
append_forbidden_skill_root_if_present "${SKILL_DIR}/.."
...
case "${ACTION}" in
  plan-compare|compare-prep)
    ...
    FALLBACK_UPSTREAM_PATH=".work/upstream-sources/${PROJECT_SLUG}"
