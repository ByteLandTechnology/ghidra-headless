...
workspace, a Homebrew install root was observed at
`/opt/homebrew/Cellar/ghidra/12.0.4/libexec`, and the end-to-end Ghidra replay
path below was rerun against that install with reviewable reports written under
...
installed-skill-root: /path/to/installed/ghidra-headless/
sample-doc-root: /path/to/installed/ghidra-headless/examples/artifacts/sample-target/
