...
against the Homebrew install root at
`/opt/homebrew/Cellar/ghidra/12.0.4/libexec`. Runtime-specific behavior is
captured in `./artifacts/sample-target/latest-version-validation.md`.
