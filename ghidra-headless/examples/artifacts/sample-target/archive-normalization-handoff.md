...
- `.agents/skills/ghidra-headless/examples/artifacts/sample-target/archive-intake-record.md`
- `.agents/skills/ghidra-headless/examples/artifacts/sample-target/archive-member-inventory.md`
- `.agents/skills/ghidra-headless/examples/artifacts/sample-target/archive-replay-command-record.md`
