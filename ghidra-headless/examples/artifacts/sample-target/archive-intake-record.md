...
| `replay_record_path`       | `.agents/skills/ghidra-headless/examples/artifacts/sample-target/archive-replay-command-record.md` | Use the tracked sample replay record to rerun the same normalization pass.              |
